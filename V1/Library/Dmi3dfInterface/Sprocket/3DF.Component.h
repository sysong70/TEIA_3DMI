...
namespace H3DF
{
	...
	public:
        enum class Type : uint32_t {
            ...
            ExchangeDrawingModel = 0x00009001, // Represents an A3DDrawingModel in Exchange. This is the starting point of a drawing. It is found
            ...
            ExchangeDrawingView = 0x00009002, // Represents an A3DDrawingView in Exchange. A Drawing Sheet can contain views. Views are basically
            ...
            ExchangeDrawingSheet = 0x00009003, // Represents an A3DDrawingSheet in Exchange. A DrawingModel contains one or more sheets. Each sheet
            ...
            ExchangeBasicDrawingBlock = 0x00009004, // Represents an A3DDrawingBlockBasic in Exchange. Sheets and views contain blocks. Blocks can be of
            ...
            ExchangeOperatorDrawingBlock = 0x00009005, // Represents an A3DDrawingBlockOperator in Exchange. Sheets and views contain blocks. Blocks can be
        ...
        MetaData * GetMetaData(H3DF::MetaDataIndex eInIndex) const;
