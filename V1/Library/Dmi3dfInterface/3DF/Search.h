...
namespace H3DF
{
	...
	public:
		...
		enum class Type : uint32_t
		{
			...
			Shader										= 0x2001b000,	// Search for any custom shader (pixel or/and vertex) attribute settings.
			ShaderTriangles								= 0x2001b001,	// Search for any custom shader (pixel or/and vertex) for triangles attribute settings.
			ShaderLines									= 0x2001b002,	// Search for any custom shader (pixel or/and vertex) for lines attribute settings.
			ShaderPoints								= 0x2001b003,	// Search for any custom shader (pixel or/and vertex) for points attribute settings.

			PixelShader									= 0x2001c000,	// Search for any pixel shader attribute settings.
			PixelShaderSource							= 0x2001c001,	// Search for pixel shader source settings.
			PixelShaderInputs							= 0x2001c002,	// Search for pixel shader inputs settings.
			PixelShaderUniforms							= 0x2001c003,	// Search for pixel shader uniforms settings.
			PixelShaderUniformData						= 0x2001c004,	// Search for pixel shader uniform data settings.

			VertexShader								= 0x2001d000,	// Search for any vertex shader attribute settings.
			VertexShaderSource							= 0x2001d001,	// Search for vertex shader source settings.
			VertexShaderInputs							= 0x2001d002,	// Search for vertex shader inputs settings.
			VertexShaderUniforms						= 0x2001d003,	// Search for vertex shader uniforms settings.
			VertexShaderOutputs							= 0x2001d004,	// Search for vertex shader outputs settings.
			VertexShaderUniformData						= 0x2001d005,	// Search for vertex shader uniform data settings.
	...
	public:
		...
		SearchOptionsKit & operator = (SearchOptionsKit const & cInThat);
	};
