...
public:
	...
	OdRxObjectPtr object() const
	{
		...
		OdSmartPtr<ExUndoControllerRecord> pRec = OdRxObjectImpl<ExUndoControllerRecord>::createObject();
...
{
	OdSmartPtr<ExUndoControllerIterator> pIter = OdRxObjectImpl<ExUndoControllerIterator>::createObject();
